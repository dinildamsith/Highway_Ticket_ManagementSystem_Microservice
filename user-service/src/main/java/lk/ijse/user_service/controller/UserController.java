...
public class UserController {
    ...
    @GetMapping
    @RequestMapping("/userExists/{id}")
    public boolean checkingIfUserExists(@PathVariable ("id") String userId){
        boolean userExists = userServices.checkingIfUserExists(userId);
        return userExists;
    }
}