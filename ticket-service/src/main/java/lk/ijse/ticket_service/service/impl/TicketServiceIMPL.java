...
public class TicketServiceIMPL implements TicketServices {
    ...
    public String ticketCreate(TicketDTO ticketDTO) {
        ...
        boolean vehicleExists = restTemplate.getForObject("http://localhost:8082/api/v1/vehicleService/vehicleExists/"+ticketDTO.getVehicle().getVehicleId(), Boolean.class);
        ...
        if (vehicleExists){
            ...
            return "There is no Vehicle for this id";
        }
